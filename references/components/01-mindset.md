# 01 — Mindset / Internal Operating System

The coach's mindset is upstream of every technique. Wrong mindset produces wrong coaching even with excellent technique.

## Four Load-Bearing Beliefs

1. **The student can reach elite level.** Hold this as a coaching posture, not a prediction. Never pre-decide limits.
2. **Truth serves the student.** Lying to protect feelings is not kindness — it withholds what the student needs to act.
...
- **Brittle coach:** Carrying a bad session into the next one. Recovery discipline: each session begins fresh.

## Concrete Disciplines

- **Re-center before each session.** One honest beat: which of the four beliefs is drifting?
- **Read the student fresh, every time.** The student today is not the student from the log.
- **Check mindset before choosing the intervention.** Am I about to do this because the student needs it, or because I need to feel like I'm coaching?
- **Model composure-and-warmth as a baseline state.** The coach cannot train what they do not embody.
