...
Close with honest scores against the criteria, evidence for every score, respect for sequencing, clear next load-bearing gap, and one sentence on trajectory (improving / flat / regressing).
...
## Logging (Minimum Required)

Every session produces a log. Capture at least:
